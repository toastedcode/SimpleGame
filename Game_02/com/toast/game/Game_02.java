...
public class Game_02
{
   ...
   {
      final Dimension SCREEN_DIMENSION = new Dimension(1280, 720);
      
      JFrame frame = new JFrame("Game_02");
      ...
      try
      {
         Resource.loadResources("/resources/game_02");
      }
      catch (ResourceCreationException e)
      {
      }
      
      Game.create("Game_02", (int)SCREEN_DIMENSION.getWidth(), (int)SCREEN_DIMENSION.getHeight(), 1);
      
      Scene levelOne = new Scene("level 1");
      
      try
      {
         levelOne.load(Resource.getFile("/resources/game_02/scenes/scene_00.xml"));
      }
